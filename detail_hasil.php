    ...
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-1 gap-8">
            ...
            <div class="lg:col-span-2">
                <?php if ($selectedData): ?>
                <div class="bg-white rounded-[2.5rem] card-shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-6 mb-8">
                            <!-- Investasi 1 -->
                            <div class="border rounded-[2rem] p-5 <?= $selectedData['winner'] == $selectedData['nama_investasi_1'] ? 'border-green-300 bg-green-50' : '' ?>">
                            ...
                            <!-- Investasi 2 -->
                            <div class="border rounded-[2rem] p-5 <?= $selectedData['winner'] == $selectedData['nama_investasi_2'] ? 'border-green-300 bg-green-50' : '' ?>">
                                <h4 class="font-semibold text-lg mb-3 text-gray-800">
                                    <?= htmlspecialchars($selectedData['nama_investasi_2']) ?>
                        ...
                        <div class="bg-gray-100 rounded-[2rem] p-6">
                            ...
                            <div class="grid md:grid-cols-3 gap-4">
                                <div class="bg-white p-4 rounded-[1.5rem] border border-gray-200">
